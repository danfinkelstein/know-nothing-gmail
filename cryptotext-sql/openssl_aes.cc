...
//  g++ -Wall openssl_aes.cc -lcrypto -o openssl_aes
//
//  this is public domain code. 
//
//  Saju Pillai (saju.pillai@gmail.com)
// 
//  $Id: openssl_aes.cc 41 2010-08-23 03:09:21Z df2417 $
//
...
int main(int argc, char *argv[]) {
    ...
    // key_data = (unsigned char *) argv[1];       // Causes segfault if no argument
    // key_data_len = strlen(argv[1]);     // Causes segfault if no argument
	string passphrase = "cuenctest1";
	key_data = (unsigned char *) passphrase.c_str();
	key_data_len = passphrase.length();
