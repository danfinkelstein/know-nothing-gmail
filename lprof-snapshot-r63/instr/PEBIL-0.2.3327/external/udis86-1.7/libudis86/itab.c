...
static struct ud_itab_entry itab__pfx_sse66__0f__op___3byte_38__reg[256] = {
  ...
  /* 2E */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
  /* 2F */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
  /* 30 */  { UD_Ipmovzxbw,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 31 */  { UD_Ipmovzxbd,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 32 */  { UD_Ipmovzxbq,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 33 */  { UD_Ipmovzxwd,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 34 */  { UD_Ipmovzxwq,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 35 */  { UD_Ipmovzxdq,    O_V,     O_W,     O_NONE,  P_aso|P_oso|P_rexr|P_rexx|P_rexb },
  /* 36 */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
  /* 37 */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
  /* 38 */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
  /* 39 */  { UD_Iinvalid,     O_NONE, O_NONE, O_NONE,    P_none },
